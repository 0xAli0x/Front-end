    ...
    <div className="m-1 p-1 bg-red-700" >
        ...
        <div className="flex container flex-row sm:flex-col md:w-1/4 justify-center align-center items-center bg-[#110402] p-6 w-4/5 m-3 border-2 border-black-500 hover:border-gray-500 ">
          ...
          <Link href="#create">
            <Image
              src={uploadIcon}
              alt="Upload icon"
              className="w-40 h-40 object-contain pt-5 hover:cursor-pointer"
            />
          </Link>
        </div>
        <div className="flex flex-row sm:flex-col justify-center align-center items-center bg-[#110402] p-6 md:w-1/4 w-4/5 m-3">
          <p className="justify-center text-center">
            Parsing algorithm generates a prompt for our fine-tuned AI model
          </p>
          <Link href="#create">
            <Image
              src={aiIcon}
      ...
      <div className="flex justify-center">
        <button
          onClick={() =>
            alert(
              "'Explore' button clicked, explore section id not yet implemented, please wait for future updates."
            )
          }
          href="#explore"
          className="  
      ...
      <div className="flex justify-center mt-8 mb-8">
        <Link href="#">
          ...
          <button
            onClick={() =>
              alert(
                "'Go Premium' button clicked, currently our service is free for all."
              )
            }
            className="  
